...
export const FilledButton = ({ children, style, labelStyle, onPress, testID }: BaseButtonProps) => {
    ...
    return (
        <BaseButton style={buttonStyle} labelStyle={_labelStyle} onPress={onPress} testID={testID}>
            {children}
        </BaseButton>
    );
};
