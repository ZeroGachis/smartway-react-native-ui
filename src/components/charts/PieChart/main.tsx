...
export const PieChartMain = (props: propTypes) => {
    ...
    const innerCircleBorderWidth =
        props.innerCircleBorderWidth || (props.innerCircleBorderColor ? strokeWidth || 2 : 0);
    ...
    return (
        ...
        >
            ...
            >
                ...
                {data.length === 1 ? (
                    <>
                        <Circle
                            ...
                            r={radius}
                            fill={
                                showGradient ? `url(#grad${0})` : data[0].color || pieColors[0 % 9]
                            }
                            onPress={() => {
                                data[0].onPress
                                    ? data[0].onPress()
                ...
                {showText &&
                    data.map((item, index) => {
                        const mx = cx * (1 + Math.sin(2 * pi * mData[index] + initialAngle));
                        const my = cy * (1 - Math.cos(2 * pi * mData[index] + initialAngle));
                        ...
                        return (
                            <React.Fragment key={index}>
                                ...
                                <SvgText
                                    fill={item.textColor || textColor || pieColors[(index + 2) % 9]}
