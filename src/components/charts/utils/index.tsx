...
export const getCumulativeWidth = (data: any, index: number, spacing: number) => {
    let cumWidth = 0;
...
export const svgPath = (points: Array<Array<number>>, curveType: CurveType, curvature: number) => {
...
export const getArrowPoints = (
    ...
    const d = arrowLength;
    const d2 = arrowWidth / 2;
    const interSectionX = arrowTipX - Math.sqrt((d * d) / (dataLineSlope * dataLineSlope + 1));
...
export const getSecondaryDataWithOffsetIncluded = (secondaryData, secondaryYAxis) => {
...
export const getAllArrowProperties = (props: any, defaultArrowConfig: arrowConfigType) => {
    ...
    const arrowStrokeWidth1 = getArrowProperty('strokeWidth', 1, props, defaultArrowConfig);
    ...
    const arrowStrokeWidth2 = getArrowProperty('strokeWidth', 2, props, defaultArrowConfig);
    ...
    const showArrowBase2 = getArrowProperty('showArrowBase', 2, props, defaultArrowConfig);
    ...
    const arrowStrokeWidth3 = getArrowProperty('strokeWidth', 3, props, defaultArrowConfig);
    ...
    const arrowStrokeWidth4 = getArrowProperty('strokeWidth', 4, props, defaultArrowConfig);
    const arrowStrokeColor4 = getArrowProperty('strokeColor', 4, props, defaultArrowConfig);
    ...
    const arrowStrokeWidth5 = getArrowProperty('strokeWidth', 5, props, defaultArrowConfig);
    const arrowStrokeColor5 = getArrowProperty('strokeColor', 5, props, defaultArrowConfig);
    const arrowFillColor5 = getArrowProperty('fillColor', 5, props, defaultArrowConfig);
...
export const maxAndMinUtil = (maxItem, minItem, roundToDigits, showFractionalValues): MaxAndMin => {
...
export const computeMaxAndMinItems = (data, roundToDigits, showFractionalValues): MaxAndMin => {
    if (!data) {
