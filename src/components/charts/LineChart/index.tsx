...
export const LineChart = (props: LineChartPropsType) => {
    ...
    const containerHeight =
        props.height ??
        ((props.stepHeight ?? 0) * noOfSections || AxesAndRulesDefaults.containerHeight);
    const data = useMemo(() => {
        if (!props.data) {
            return [];
        }
    ...
    const secondaryData =
        getSecondaryDataWithOffsetIncluded(props.secondaryData, props.secondaryYAxis) || [];
    ...
    const animationDuration = props.animationDuration || LineDefaults.animationDuration;
    ...
    const animateOnDataChange = props.yAxisOffset ? false : props.animateOnDataChange || false;
    ...
    const endSpacing = props.endSpacing ?? (adjustToWidth ? 0 : LineDefaults.endSpacing);
    ...
    const spacing =
        props.spacing ??
        (adjustToWidth
            ? ((props.width ?? AxesAndRulesDefaults.width) - initialSpacing) / (data.length - 1)
            : LineDefaults.spacing);

    const xAxisThickness = props.xAxisThickness ?? AxesAndRulesDefaults.xAxisThickness;
    const dataPointsHeight1 =
        props.dataPointsHeight1 ?? props.dataPointsHeight ?? LineDefaults.dataPointsHeight;
    const dataPointsWidth1 =
        props.dataPointsWidth1 ?? props.dataPointsWidth ?? LineDefaults.dataPointsWidth;
    const dataPointsRadius1 =
        props.dataPointsRadius1 ?? props.dataPointsRadius ?? LineDefaults.dataPointsRadius;
    const dataPointsColor1 =
        props.dataPointsColor1 ?? props.dataPointsColor ?? LineDefaults.dataPointsColor;
    const dataPointsShape1 =
        props.dataPointsShape1 ?? props.dataPointsShape ?? LineDefaults.dataPointsShape;

    const dataPointsHeight2 =
        props.dataPointsHeight2 ?? props.dataPointsHeight ?? LineDefaults.dataPointsHeight;
    const dataPointsWidth2 =
        props.dataPointsWidth2 ?? props.dataPointsWidth ?? LineDefaults.dataPointsWidth;
    const dataPointsRadius2 =
        props.dataPointsRadius2 ?? props.dataPointsRadius ?? LineDefaults.dataPointsRadius;
    const dataPointsColor2 =
        props.dataPointsColor2 ?? props.dataPointsColor ?? LineDefaults.dataPointsColor2;
    const dataPointsShape2 =
        props.dataPointsShape2 ?? props.dataPointsShape ?? LineDefaults.dataPointsShape;

    const dataPointsHeight3 =
        props.dataPointsHeight3 ?? props.dataPointsHeight ?? LineDefaults.dataPointsHeight;
    const dataPointsWidth3 =
        props.dataPointsWidth3 ?? props.dataPointsWidth ?? LineDefaults.dataPointsWidth;
    const dataPointsRadius3 =
        props.dataPointsRadius3 ?? props.dataPointsRadius ?? LineDefaults.dataPointsRadius;
    const dataPointsColor3 =
        props.dataPointsColor3 ?? props.dataPointsColor ?? LineDefaults.dataPointsColor3;
    const dataPointsShape3 =
        props.dataPointsShape3 ?? props.dataPointsShape ?? LineDefaults.dataPointsShape;

    const dataPointsHeight4 =
        props.dataPointsHeight4 ?? props.dataPointsHeight ?? LineDefaults.dataPointsHeight;
    const dataPointsWidth4 =
        props.dataPointsWidth4 ?? props.dataPointsWidth ?? LineDefaults.dataPointsWidth;
    const dataPointsRadius4 =
        props.dataPointsRadius4 ?? props.dataPointsRadius ?? LineDefaults.dataPointsRadius;
    const dataPointsColor4 =
        props.dataPointsColor4 ?? props.dataPointsColor ?? LineDefaults.dataPointsColor;
    const dataPointsShape4 =
        props.dataPointsShape4 ?? props.dataPointsShape ?? LineDefaults.dataPointsShape;

    const dataPointsHeight5 =
        props.dataPointsHeight5 ?? props.dataPointsHeight ?? LineDefaults.dataPointsHeight;
    const dataPointsWidth5 =
        props.dataPointsWidth5 ?? props.dataPointsWidth ?? LineDefaults.dataPointsWidth;
    const dataPointsRadius5 =
        props.dataPointsRadius5 ?? props.dataPointsRadius ?? LineDefaults.dataPointsRadius;
    const dataPointsColor5 =
        props.dataPointsColor5 ?? props.dataPointsColor ?? LineDefaults.dataPointsColor;
    const dataPointsShape5 =
        props.dataPointsShape5 ?? props.dataPointsShape ?? LineDefaults.dataPointsShape;
    ...
    const atLeastOneAreaChart =
        areaChart || areaChart1 || areaChart2 || areaChart3 || areaChart4 || areaChart5;

    const textFontSize1 = props.textFontSize1 ?? props.textFontSize ?? LineDefaults.textFontSize;
    const textFontSize2 = props.textFontSize2 ?? props.textFontSize ?? LineDefaults.textFontSize;
    const textFontSize3 = props.textFontSize3 ?? props.textFontSize ?? LineDefaults.textFontSize;
    const textFontSize4 = props.textFontSize4 ?? props.textFontSize ?? LineDefaults.textFontSize;
    const textFontSize5 = props.textFontSize5 ?? props.textFontSize ?? LineDefaults.textFontSize;
    const textColor1 = props.textColor1 ?? props.textColor ?? LineDefaults.textColor;
    const textColor2 = props.textColor2 ?? props.textColor ?? LineDefaults.textColor;
    const textColor3 = props.textColor3 ?? props.textColor ?? LineDefaults.textColor;
    const textColor4 = props.textColor4 ?? props.textColor ?? LineDefaults.textColor;
    const textColor5 = props.textColor5 ?? props.textColor ?? LineDefaults.textColor;
    ...
    const getY = (value) => extendedContainerHeight - (value * containerHeight) / maxValue;
    ...
    const secondaryMaxValue = props.secondaryYAxis?.maxValue ?? (secondaryMaxItem || maxValue);
    ...
    const thickness1 = props.thickness1 ?? props.thickness ?? LineDefaults.thickness;
    const thickness2 = props.thickness2 ?? props.thickness ?? LineDefaults.thickness;
    const thickness3 = props.thickness3 ?? props.thickness ?? LineDefaults.thickness;
    const thickness4 = props.thickness4 ?? props.thickness ?? LineDefaults.thickness;
    const thickness5 = props.thickness5 ?? props.thickness ?? LineDefaults.thickness;
    ...
    const endFillColor1 = props.endFillColor1 ?? props.endFillColor ?? LineDefaults.endFillColor;
    ...
    const endFillColor2 = props.endFillColor2 ?? props.endFillColor ?? LineDefaults.endFillColor;
    ...
    const endFillColor3 = props.endFillColor3 ?? props.endFillColor ?? LineDefaults.endFillColor;
    ...
    const endFillColor4 = props.endFillColor4 ?? props.endFillColor ?? LineDefaults.endFillColor;
    ...
    const endFillColor5 = props.endFillColor5 ?? props.endFillColor ?? LineDefaults.endFillColor;
    ...
    const secondaryLineConfig = {
        ...
        strokeDashArray: props.secondaryLineConfig?.strokeDashArray ?? strokeDashArray1,
        startIndex: props.secondaryLineConfig?.startIndex ?? startIndex1,
        endIndex: props.secondaryLineConfig?.endIndex ?? endIndex1,
        hideDataPoints: props.secondaryLineConfig?.hideDataPoints ?? hideDataPoints1,
        dataPointsHeight: props.secondaryLineConfig?.dataPointsHeight ?? dataPointsHeight1,
        dataPointsWidth: props.secondaryLineConfig?.dataPointsWidth ?? dataPointsWidth1,
        dataPointsRadius: props.secondaryLineConfig?.dataPointsRadius ?? dataPointsRadius1,
        dataPointsColor: props.secondaryLineConfig?.dataPointsColor ?? dataPointsColor1,
        dataPointsShape: props.secondaryLineConfig?.dataPointsShape ?? dataPointsShape1,
        showValuesAsDataPointsText:
            props.secondaryLineConfig?.showValuesAsDataPointsText ?? showValuesAsDataPointsText,
        startFillColor: props.secondaryLineConfig?.startFillColor ?? startFillColor1,
    ...
    const addLeadingAndTrailingPathForAreaFill = (initialPath, value, dataLength) => {
        return (
            'M ' +
            initialSpacing +
            ',' +
    ...
    useEffect(() => {
        ...
        if (!props.curved) {
            ...
            if (atLeastOneAreaChart) {
                ...
                if ((areaChart || areaChart4) && data4.length) {
                    xx4 = addLeadingAndTrailingPathForAreaFill(xx, data4[0].value, data4.length);
                    setFillPoints4(xx4);
                }
        ...
        if (!secondaryLineConfig.curved) {
            for (let i = 0; i < secondaryData.length; i++) {
                if (
                    ...
                    pp += 'L' + getX(i) + ' ' + getSecondaryY(secondaryData[i].value) + ' ';
                }
            }
            ...
            const p1Array: Array<Array<number>> = [];
            for (let i = 0; i < secondaryData.length; i++) {
                if (i >= secondaryLineConfig.startIndex && i <= secondaryLineConfig.endIndex) {
                    p1Array.push([getX(i), getSecondaryY(secondaryData[i].value)]);
                }
            }

            let xx = svgPath(p1Array, secondaryLineConfig.curveType, secondaryLineConfig.curvature);
    ...
    const showXAxisIndices = props.showXAxisIndices ?? AxesAndRulesDefaults.showXAxisIndices;
    const xAxisIndicesHeight = props.xAxisIndicesHeight ?? AxesAndRulesDefaults.xAxisIndicesHeight;
    const xAxisIndicesWidth = props.xAxisIndicesWidth ?? AxesAndRulesDefaults.xAxisIndicesWidth;
    const xAxisIndicesColor = props.xAxisIndicesColor ?? AxesAndRulesDefaults.xAxisIndicesColor;
    ...
    const pointerWidth = pointerConfig?.width ? pointerConfig.width : defaultPointerConfig.width;
    ...
    const showPointerStrip =
        pointerConfig?.showPointerStrip === false ? false : defaultPointerConfig.showPointerStrip;
    ...
    const disableScroll =
        ...
        (pointerConfig
            ? activatePointersOnLongPress
                ...
                : true
            : false);
    const showScrollIndicator = props.showScrollIndicator ?? LineDefaults.showScrollIndicator;

    const focusEnabled = props.focusEnabled ?? LineDefaults.focusEnabled;
    const showDataPointOnFocus = props.showDataPointOnFocus ?? LineDefaults.showDataPointOnFocus;
    const showStripOnFocus = props.showStripOnFocus ?? LineDefaults.showStripOnFocus;
    ...
    const unFocusOnPressOut = props.unFocusOnPressOut ?? LineDefaults.unFocusOnPressOut;
    const delayBeforeUnFocus = props.delayBeforeUnFocus ?? LineDefaults.delayBeforeUnFocus;
                ...
                <Fragment key={index}>
                    ...
                    (focusEnabled && index === selectedIndex && showStripOnFocus) ? (
                        <Rect
                            ...
                            height={
                                currentStripHeight || containerHeight - dataPointsHeight / 2 + 20
                            }
            ...
            if (item.showVerticalLine) {
                return (
                    <Rect
                        ...
                        x={
                            getX(index) -
                            (item.verticalLineThickness || props.verticalLinesThickness || 1) / 2
                        }
                        y={item.verticalLineUptoDataPoint ? getY(item.value) : -xAxisThickness}
    ...
    const renderStripAndLabel = () => {
        ...
        const pointerYLocal = Math.min(...arr);
        ...
        if (autoAdjustPointerLabelPosition) {
            if (pointerX < pointerLabelWidth / 2) {
                ...
                if (
                    !activatePointersOnLongPress &&
                    pointerX >
                        (props.width || Dimensions.get('window').width - yAxisLabelWidth - 15) -
                            pointerLabelWidth / 2
                ) {
    ...
    const renderLine = (
        ...
        return (
            <View
                onStartShouldSetResponder={(_) => (pointerConfig ? true : false)}
                onMoveShouldSetResponder={(_) => (pointerConfig ? true : false)}
                onResponderGrant={(evt) => {
                    ...
                    const z =
                        initialSpacing + spacing * factor - (pointerRadius || pointerWidth / 2) - 2;
                    setPointerX(z);
                ...
                style={{
                    ...
                    bottom: 60 + labelsExtraHeight - (props.overflowBottom ?? dataPointsRadius1),
                    width: totalWidth,
                    zIndex: zIndex,
                }}
            >
