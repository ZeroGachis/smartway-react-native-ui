...
import { AxesAndRulesDefaults, chartTypes, yAxisSides } from '../../utils/constants';
import { HorizSectionsType, horizSectionPropTypes, secondaryYAxisType } from '../../utils/types';
...
export const renderHorizSections = (props: horizSectionPropTypes) => {
    ...
    const secondaryYAxisConfig: secondaryYAxisType = {
        ...
        showFractionalValues: secondaryYAxis?.showFractionalValues ?? showFractionalValues,
        ...
        yAxisIndicesHeight: secondaryYAxis?.yAxisIndicesHeight ?? yAxisIndicesHeight,
        ...
        yAxisTextNumberOfLines: secondaryYAxis?.yAxisTextNumberOfLines ?? yAxisTextNumberOfLines,
    ...
    secondaryYAxisConfig.maxValue = secondaryYAxisConfig.maxValue ?? (maxItem || maxValue);
    secondaryYAxisConfig.minValue = secondaryYAxisConfig.maxValue ?? minItem;
    secondaryYAxisConfig.stepValue =
        secondaryYAxisConfig.stepValue ??
        secondaryYAxisConfig.maxValue / (secondaryYAxisConfig.noOfSections ?? noOfSections);
    ...
    for (let i = 0; i <= noOfSections; i++) {
        ...
        if (showFractionalValues || roundToDigits) {
            value = parseFloat(value.toFixed(roundToDigits ?? AxesAndRulesDefaults.roundToDigits));
        }
        horizSections.push({
    ...
    if (secondaryYAxis) {
        for (let i = 0; i <= (secondaryYAxisConfig.noOfSections ?? noOfSections); i++) {
            ...
            if (secondaryYAxisConfig.showFractionalValues || secondaryYAxisConfig.roundToDigits) {
                value = parseFloat(
                    value.toFixed(
                        secondaryYAxisConfig.roundToDigits ?? AxesAndRulesDefaults.roundToDigits,
                    ),
                );
            }
    ...
    referenceLine1Config = referenceLinesConfig.referenceLine1Config
        ? {
              ...
              color:
                  referenceLinesConfig.referenceLine1Config.color || defaultReferenceConfig.color,
    ...
    referenceLine2Config = referenceLinesConfig.referenceLine2Config
        ? {
              ...
              color:
                  referenceLinesConfig.referenceLine2Config.color || defaultReferenceConfig.color,
    ...
    referenceLine3Config = referenceLinesConfig.referenceLine3Config
        ? {
              ...
              color:
                  referenceLinesConfig.referenceLine3Config.color || defaultReferenceConfig.color,
                                        ...
                                        {secondaryYAxisConfig.showYAxisIndices && index !== 0 ? (
                                            <View
                                                style={{
                                                    ...
                                                    position: 'absolute',
                                                    left:
                                                        (secondaryYAxisConfig.yAxisIndicesWidth ??
                                                            0) / -2,
                                                    backgroundColor:
