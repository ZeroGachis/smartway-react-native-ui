...
export const Dialog = (props : DialogProps) => {
    ...
    const defaultDismissButtonLabel: string = 'Annuler';
    const defaultConfirmButtonLabel: string = 'Ok';
    ...
    return (
        <BaseDialog visible={props.visible} onDismiss={props.onDismiss}>
            <View style={_dialogStyle}>
                ...
                <Body style={_contentStyle}>
                    {props.content}
                </Body>
                <View style={_actionsStyle}>
                    <Button mode='text' onClick={props.onDismiss}>{props.dismissButtonLabel ?? defaultDismissButtonLabel}</Button>
                    <Button mode='filled' onClick={props.onConfirm}>{props.confirmButtonLabel ?? defaultConfirmButtonLabel}</Button>
                </View>
            </View>
        </BaseDialog>
    )
